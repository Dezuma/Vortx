...
## 1. Oracle strategy (build in public)

**Idea:** Treat the resolution / probability engine as a **public source of truth** on social platforms.
...
## 2. “Parasitic” integration (meet users where they read)
...
- `vortx/frontend/` — **Vite + Tailwind** on **Cloudflare Pages**; **TanStack Query** + Supabase client for odds/news.  
- `vortx/workers/` — bot posting, cron, webhooks (can call Supabase Edge Functions).  
